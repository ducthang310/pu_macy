...
class Sm_DynamicSlideshow_Block_List extends Mage_Core_Block_Template
{
	...
	public function getScriptTags(){
		...
		if (null == Mage::registry('jsmart.jquerynoconfict')){
			// add once noConflict
			$import_str .= $jsHelper->includeSkinScript('sm/dynamicslideshow/js/jsmart.noconflict.js');
		...
		if (null == Mage::registry('jsmart.dynamicslideshow.js')){
			// add script for this module.
			 ...
			 $import_str .= $jsHelper->includeSkinScript('sm/dynamicslideshow/js/jquery.themepunch.revolution.min.js');
